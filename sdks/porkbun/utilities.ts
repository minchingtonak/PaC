...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("porkbun");
			params.setVersion("0.2.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2ppYW55dWFuL3BvcmtidW4iLCJ2ZXJzaW9uIjoiMC4yLjAifX0="), c => c.charCodeAt(0)));
